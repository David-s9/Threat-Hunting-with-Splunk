...
Before starting to hunt for threats on the network, I first learn a little bit about the operating environment. If you have access to Splunk Enterprise, you can follow a similar process that I used.
<br><br>
The first step is to open Splunk and in the Search & Reporting app type the following SPL to view data sourcetypes, sorting them by the total count number.
